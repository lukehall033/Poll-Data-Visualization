...
public class StudentTest extends TestCase {
    ...
    public void setUp()
    {
        student = new Student(100, "11/11/2019 1:26", "CS", "Southeastern", "video games", list);
    }
    ...
    public void testEquals()
    {
        ...
        Student student2 = new Student(200, "11/11/2019 1:26", "CS", "Southeastern", "video games", list);
        Student student3 = new Student(100, "11/12/2019 1:26", "CS", "Southeastern", "video games", list);
        Student student4 = new Student(100, "11/11/2019 1:26", "Math", "Southeastern", "video games", list);
        Student student5 = new Student(100, "11/11/2019 1:26", "CS", "North", "video games", list);
        Student student6 = new Student(100, "11/11/2019 1:26", "CS", "Southeastern", "sports", list);
